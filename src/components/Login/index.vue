...
.login_body .login_text{ width:100%; height: 50px; border:none; border-bottom: 1px #ccc solid; margin-bottom: 5px; outline: none; text-indent: 10px;}
...
.login_body .login_link a{ text-decoration: none; margin:0 5px; font-size: 16px; color:#e54847;}
</style>
